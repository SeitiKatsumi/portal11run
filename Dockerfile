...
ENV VIRTUAL_CIRCUIT_PRIVATE_UPLOAD_DIR=/data/virtual-circuit-private
ENV SUPPORT_PRIVATE_UPLOAD_DIR=/data/support-private
ENV CHALLENGE_PRIVATE_UPLOAD_DIR=/data/member-challenges-private
ENV NEXT_TELEMETRY_DISABLED=1
...
RUN mkdir -p /data/uploads /data/virtual-circuit-private /data/support-private /data/member-challenges-private
EXPOSE 80
