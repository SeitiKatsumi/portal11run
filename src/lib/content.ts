...
export const projects: ProjectPage[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "O 11 Master nasce para atletas que continuam levando o esporte a sério, independentemente da idade.",
    ...
    notice:
      "Importante: o 11 Master é uma iniciativa 100% privada da 11RUN, sem apoio, vínculo institucional ou qualquer relação com a Prefeitura de Itatiba ou com o Departamento de Esportes de Itatiba.",
    banner: {
      eyebrow: "11 Master",
