export const circuitFaq = [
  ...
  ["Como funcionam as premiações?", "Há três classificações cumulativas, sempre separadas por categoria e gênero: mensal, do primeiro ao último dia de cada mês; bimestral, de 01/08 a 30/09 e de 01/10 a 30/11; e absoluta, de 01/08 a 30/11. Somente marcas validadas e homologadas geram direito a prêmio."],
  ...
  ["Quando o ranking de cada período é encerrado?", "O ranking mensal fecha no último dia de cada mês. Os bimestres fecham em 30/09 e 30/11. O ranking absoluto e a edição encerram em 30/11/2026. A classificação permanece provisória até a homologação da comissão."],
...
export const circuitRegulations = [
  ...
  ["2. Do período", "A edição será realizada de 1º de agosto a 30 de novembro de 2026. Os rankings mensais consideram o primeiro e o último dia de agosto, setembro, outubro e novembro. Os rankings bimestrais consideram 01/08 a 30/09 e 01/10 a 30/11. O ranking absoluto considera exclusivamente marcas realizadas entre 01/08 e 30/11. Atividades com data anterior ao início serão registradas como realizadas em 1º de agosto de 2026."],
