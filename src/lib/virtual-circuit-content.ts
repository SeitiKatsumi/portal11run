...
export const circuitFaq = [
  ...
  ["Como funcionam as premiações?", "Há três classificações cumulativas, sempre separadas por categoria e gênero: mensal, até o último dia de cada mês, exceto novembro, que termina em 14/11; bimestral, de 01/08 a 30/09 e de 01/10 a 14/11; e absoluta, de 01/08 a 14/11. Somente marcas validadas e homologadas geram direito a prêmio."],
  ["As premiações mensal, bimestral e absoluta se acumulam?", "Sim. Um atleta pode receber as premiações correspondentes à sua posição em mais de um período. Dentro de cada período, os itens também são cumulativos conforme a colocação publicada."],
  ["Quando o ranking de cada período é encerrado?", "O ranking mensal fecha no último dia de cada mês, exceto novembro, encerrado em 14/11. Os bimestres fecham em 30/09 e 14/11. O ranking absoluto e a edição encerram em 14/11/2026. A classificação permanece provisória até a homologação da comissão."],
...
export const circuitRegulations = [
  ...
  ["2. Do período", "A edição será realizada de 1º de agosto a 14 de novembro de 2026. Os rankings mensais abrangem agosto, setembro e outubro completos e novembro de 01/11 a 14/11. Os rankings bimestrais consideram 01/08 a 30/09 e 01/10 a 14/11. O ranking absoluto considera exclusivamente marcas realizadas entre 01/08 e 14/11. Atividades fora desse período preservam a data original no histórico e não participam da classificação."],
  ["2.1. Da evolução", "A evolução compara a melhor marca do primeiro dia com a melhor marca em data posterior dentro do período selecionado: (tempo inicial menos melhor posterior) dividido pelo tempo inicial, multiplicado por 100. Exige duas datas distintas. Sem redução, o percentual é zero. Empates são ordenados pela data da melhor marca e pelo número do atleta. A classificação de evolução não altera os prêmios por tempo absoluto."],
