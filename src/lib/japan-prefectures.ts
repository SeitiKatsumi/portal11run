const prefectures: Record<string, string> = {
  ...
  東京: "Tóquio", 神奈川: "Kanagawa", 新潟: "Niigata", 富山: "Toyama", 石川: "Ishikawa", 福井: "Fukui",
  山梨: "Yamanashi", 長野: "Nagano", 岐阜: "Gifu", 静岡: "Shizuoka", 愛知: "Aichi", 三重: "Mie",
  滋賀: "Shiga", 京都: "Quioto", 大阪: "Osaka", 兵庫: "Hyogo", 奈良: "Nara", 和歌山: "Wakayama",
...
export function prefectureInPortuguese(value: string | undefined) {
  return value ? prefectures[value] : undefined;
}
