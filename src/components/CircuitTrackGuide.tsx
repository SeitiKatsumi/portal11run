 ...
 return <div className={styles.guide}>
  ...
  <figure className={styles.figure}>
   <svg viewBox="0 0 780 530" role="img" aria-label="Pista de 400 metros com oito raias. Largada na marca dos 200 metros da raia 1, sentido anti-horário, chegada ao final da reta dos 100 metros após duas voltas e meia, totalizando 1.000 metros.">
    ...
    {/* Sprint recess sits to the left, before the 100 m start. */}
    {Array.from({length:9},(_,i)=><path data-sprint-recess={i} key={i} d={`M 80 ${350+i*12} H 530`} fill="none" stroke="currentColor" strokeWidth="1.2" opacity=".28"/>)}
    <path d="M 80 350 V 446 M 198 350 V 446" fill="none" stroke="currentColor" strokeWidth="1.2" opacity=".28"/>
    ...
    {Array.from({length:8},(_,i)=><text data-lane-number={i+1} key={i} x="510" y={360+i*12} className={styles.laneNumber}>{i+1}</text>)}
    ...
    <text x="130" y="493" textAnchor="middle">Recuo</text>
