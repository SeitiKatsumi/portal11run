...
import { Award, BarChart3, BookOpenCheck, CalendarCheck2, Download, FileSearch, Gauge, Lightbulb, Save, Settings2, ShieldCheck, WalletCards } from "lucide-react";
