...
const timeline = [
  ...
  },
  {
    ...
    text: "Observação de maturidade esportiva, disciplina, progresso técnico, adaptação competitiva e fortalecimento do modelo."
  },
  {
    year: "2029",
          ...
          <Reveal>
            <div className="futuro-text-block">
              <p>
                ...
                convivência no ambiente competitivo.
              </p>
              <p>
