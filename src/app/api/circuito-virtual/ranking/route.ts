import { circuitEvolution } from '@/lib/virtual-circuit-core';
...
export async function GET(request: Request) {
  ...
  const evolution = params.get("mode") === "evolution";
  ...
  return NextResponse.json({ ok: true, ranking: evolution ? circuitEvolution(ranking) : ranking });
}
