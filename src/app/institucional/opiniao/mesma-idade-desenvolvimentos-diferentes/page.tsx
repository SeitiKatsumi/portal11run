...
export default function MaturationOpinionPage() {
  ...
  return <article className={styles.page}>
    ...
    <section className={styles.signature}><div><span className={styles.eyebrow}>Próxima análise</span><h2>Formação Integral do Atleta</h2><p>Descubra por que educação, autonomia, pensamento crítico e projeto de vida fazem parte do desenvolvimento esportivo.</p><div className={styles.actions}><Link href="/referencias/analises/formacao-integral-do-atleta">Ler próxima análise <ArrowRight /></Link></div></div></section>
